...
{{--To apply pagination use ->paginate(int: num) method instead of ->get()--}}
{{--And give $var->links() to show all page's links and next prev button --}}
{{--Use $var->onEachSide(num) when you have lot more pages.--}}